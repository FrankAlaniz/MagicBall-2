...
answerElement.classList.add('text-center','fade', 'fs-3', 'fw-bold', 'bg-white', 'text-danger', 'px-2', 'py-3', 'rounded', 'w-50', 'position-absolute', 'top-50', 'start-50', 'translate-middle')
